...
public class Less_day extends AppCompatActivity {
    ...
    public TextView day1,day2,day3,day1Max,day2Max,day3Max,day1Min,day2Min,day3Min,day1Humidity,day2Humidity,day3Humidity,day1Pressure,day2Pressure,day3Pressure,city,country,latitude,longitude;
    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.three_day);
        currData=findViewById(R.id.curr_data);
    ...
    Call<WeatherResponse> call= weatherService.getTemp_coord( lat,lon, AppId);
        ...
        public void onResponse(Call<WeatherResponse> call, Response<WeatherResponse> response) {
            if(response.code()==200)
            {
                ...
                city.setText(weatherResponse.getCity().getName());
                latitude.setText(weatherResponse.getCity().getCoord().getLat()+"");
                longitude.setText(weatherResponse.getCity().getCoord().getLon()+"");
